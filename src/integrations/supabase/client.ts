...
const SUPABASE_URL = (import.meta.env.VITE_SUPABASE_URL || "https://placeholder-project-id.supabase.co").trim();
const SUPABASE_PUBLISHABLE_KEY = (import.meta.env.VITE_SUPABASE_ANON_KEY || import.meta.env.VITE_SUPABASE_PUBLISHABLE_KEY || "eyJhb...").trim();
