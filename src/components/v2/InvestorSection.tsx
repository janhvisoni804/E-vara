...
const InvestorSection = () => {
  const marketStats = [
    { label: "TAM", val: "$42.5B", sub: "Total Addressable Market", icon: Globe },
    { label: "SAM", val: "$8.2B", sub: "Serviceable Addressable Market", icon: Target },
    { label: "SOM", val: "$1.4B", sub: "Serviceable Obtainable Market", icon: BarChart3 },
  ];
        ...
        <div className="p-1 rounded-[32px] bg-gradient-to-br from-white/10 to-transparent">
          <div className="bg-graphite-light rounded-[28px] p-12 lg:p-16 flex flex-col lg:flex-row gap-12 items-center">
             <div className="lg:w-1/2 space-y-8">
                <h3 className="text-4xl font-bold text-white tracking-tight">Revenue Model & Scalability</h3>
                <div className="space-y-6">
                  {[
                    { title: "Enterprise Licensing", desc: "Annual recurring revenue from corporate reputation management." },
                    { title: "Government Partnerships", desc: "Digital sovereignty and misinformation defense contracts." },
                    { title: "API Integrations", desc: "Usage-based billing for social platforms and media houses." },
                  ].map((item, i) => (
             ...
             <div className="lg:w-1/2 w-full h-[400px] rounded-2xl bg-black/40 border border-white/5 p-8 flex flex-col justify-end relative overflow-hidden">
                ...
                <div className="relative z-10">
                   <p className="text-[10px] font-mono text-electric-blue uppercase mb-2">Growth_Projection_2026-2030</p>
